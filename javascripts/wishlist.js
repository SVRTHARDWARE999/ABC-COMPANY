document.addEventListener("DOMContentLoaded", function () {
    ...
    async function fetchWishlistProducts() {
        ...
        try {
            const response = await fetch(`https://script.google.com/macros/s/AKfycbz4meZsnUWP2QQHH3yxrMTsD_P8mNHgBmEcHwARW_6RQd7KK65auXFO9jxZ0v426F_iIQ/exec?list=${wishList}&start=${start}`);
