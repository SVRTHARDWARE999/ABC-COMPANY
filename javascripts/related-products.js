document.addEventListener("DOMContentLoaded", function() {
    ...
    async function fetchProducts() {
        ...
        try {
            const response = await fetch(`https://script.google.com/macros/s/AKfycbwqh0Hs5sOdeoFz25Kny3Zcpw9F-hJCLEJEjp7tVgj5Dl5hrqTWyzHyUByJrO5ADsXddQ/exec?category=${category}&start=${start}`);
